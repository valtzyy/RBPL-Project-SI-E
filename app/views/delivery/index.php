            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <?php foreach ($schedules as $s): ?>
                        ...
                        <tr onclick="window.location.href='/delivery/<?= $s['id'] ?>'" style="cursor:pointer;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
