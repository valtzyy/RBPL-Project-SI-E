...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Perbarui data atau status operasional akun pengguna.</p>
    </div>
</div>
...
<div class="d-flex justify-content-center align-items-start">
    <section class="panel">
        <div class="panel-header">
            ...
            <p class="text-muted mb-0" style="margin-top: 4px; font-size: 13px;">Ubah kolom yang diperlukan di bawah ini.</p>
        </div>
