...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Tambah Akun') ?> — DealerLink DMS</title>
    <style>
    ...
    <main class="content">
        ...
        <div class="topbar">
            <div>
                ...
                <p class="muted">Buat akun pengguna baru dengan hak akses spesifik.</p>
            </div>
        </div>
        ...
        <div class="page">
            ...
            <section class="panel">
                <div class="panel-header">
                    ...
                    <p class="muted" style="margin-top: 4px;">Isi formulir berikut untuk mendaftarkan akun baru.</p>
                </div>
