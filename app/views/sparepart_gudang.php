...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Gudang Suku Cadang – DealerLink') ?></title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar .page-title  { font-size: 16px; font-weight: 600; color: var(--text-primary); }
        .topbar .page-breadcrumb { font-size: 11.5px; color: var(--text-muted); margin-top: 1px; }
        ...
        <div class="card" style="margin-bottom:22px;">
            ...
            <form action="/sparepart/po/store" method="POST">
                <div class="form-grid">
                    ...
                    <!-- Pilih Suku Cadang -->
                    <div class="form-group">
                        <label class="form-label" for="sparepart_id">Suku Cadang</label>
                    ...
                    <!-- Kuantitas -->
                    <div class="form-group">
                        <label class="form-label" for="quantity">Kuantitas Pesanan</label>
                        <input
                            type="number"
                            id="quantity"
                            name="quantity"
