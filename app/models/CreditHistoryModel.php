    ...
    public function getCreditApplicationsByCustomer(int $customerId): array
    {
        return [
            [
                ...
                'dokumen' => [
                    ['nama' => 'KTP Pemohon', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 11 Jun 2026'],
                    ['nama' => 'Kartu Keluarga', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 11 Jun 2026'],
                    ['nama' => 'Slip Gaji 3 Bulan', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 12 Jun 2026'],
                    ['nama' => 'Rekening Koran 3 Bulan', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 12 Jun 2026'],
                    ['nama' => 'NPWP', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 12 Jun 2026'],
                    ['nama' => 'Bukti Domisili', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 13 Jun 2026'],
                ],
            ],
            [
                'id' => 2,
                ...
                'dokumen' => [
                    ['nama' => 'KTP Pemohon', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 3 Mar 2026'],
                    ['nama' => 'Kartu Keluarga', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 3 Mar 2026'],
                    ['nama' => 'Slip Gaji 3 Bulan', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 4 Mar 2026'],
                    ['nama' => 'Rekening Koran 3 Bulan', 'status' => 'kurang', 'catatan' => 'Hanya 2 bulan terakhir diserahkan'],
                    ['nama' => 'NPWP', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 4 Mar 2026'],
                ],
            ],
            [
                'id' => 3,
                ...
                'catatan_keputusan' => '',
                'dokumen' => [
                    ['nama' => 'KTP Pemohon', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 19 Nov 2025'],
                    ['nama' => 'Kartu Keluarga', 'status' => 'lengkap', 'catatan' => 'Terverifikasi 19 Nov 2025'],
                    ['nama' => 'Slip Gaji 3 Bulan', 'status' => 'menunggu', 'catatan' => 'Sedang diverifikasi leasing'],
                    ['nama' => 'Rekening Koran 3 Bulan', 'status' => 'menunggu', 'catatan' => 'Sedang diverifikasi leasing'],
                ],
            ],
        ];
    }
